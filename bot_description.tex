...
Per chat message:
\begin{enumerate}
    \item \textbf{Offer reading}: every incoming chat message is sent
    directly to the \texttt{offer\_reader\_v4} Ollama model, which extracts
    [price, quantity] (range outputs like
